...
public interface SQLExceptionTranslator {
	 ...
	 * APIs as well. That said, a <code>getCause() instanceof SQLException</code>
	 * check (and subsequent cast) is considered reliable when expecting JDBC access
	 * to have happened.
	 ...
	 * @see org.springframework.dao.DataAccessException#getCause()
	 */
