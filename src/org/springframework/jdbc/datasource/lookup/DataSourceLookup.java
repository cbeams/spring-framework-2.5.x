...
public interface DataSourceLookup {
	 ...
	 * @throws DataAccessResourceFailureException if the lookup failed
	 */
	DataSource getDataSource(String dataSourceName) throws DataAccessResourceFailureException;
