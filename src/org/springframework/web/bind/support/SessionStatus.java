 ...
 * e.g. of session attributes which have been implicit created
 * during this handler's processing (according to the
 * {@link org.springframework.web.bind.annotation.SessionAttributes} annotation).
 *
...
public interface SessionStatus {
	...
	/**
	 * Return whether the current handler's session processing
