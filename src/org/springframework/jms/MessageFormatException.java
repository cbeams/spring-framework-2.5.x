 ...
 * {@link javax.jms.MessageFormatException}.  This exception is thrown when
...
public class MessageFormatException extends JmsException {
     ...
     */
    public MessageFormatException( String s, Throwable ex ) {
        super( s, ex );
    }
     ...
     * exception (e.g {@link javax.jms.MessageFormatException}) that triggered
     * this exception.
     *
