 ...
 * {@link javax.jms.TransactionInProgressException}.  This exception is thrown when
...
public class TransactionInProgressException extends JmsException {
     ...
     */
    public TransactionInProgressException( String s ) {
        super( s );
    }
     ...
     */
    public TransactionInProgressException( String s, Throwable ex ) {
        super( s, ex );
    }
     ...
     * exception (e.g {@link javax.jms.TransactionInProgressException}) that triggered
     * this exception.
     *
