...
public class RequiredBeanFactoryPostProcessor implements BeanFactoryPostProcessor {
    ...
    /**
     * Sets the required annotation type.
     * <p>This setter property exists so that developers can provide their own
     * (non-Spring-specific) annotation type to indicate that a property value
     * is required.
     * <p>The default required annotation type is the {@link Required} annotation.
     * @param requiredAnnotationType the desired annotation type
     * @throws IllegalArgumentException if the supplied <code>requiredAnnotationType</code> argument is <code>null</code>
     */
     ...
     * @param propertyDescriptor the target {@link PropertyDescriptor property} (will never be <code>null</code>).
     * @return <code>true</code> if the supplied property has been marked as being required; <code>false</code> if not,
     *         or if the supplied property does not have a setter method.
     */
    protected boolean isRequired(PropertyDescriptor propertyDescriptor) {
        Method setter = propertyDescriptor.getWriteMethod();
        return (setter != null
                && setter.getAnnotation(this.requiredAnnotationType) != null);
    }
    ...
    private void processBeanDefinition(BeanDefinition beanDefinition, String beanDefinitionName) {
        ...
        for (PropertyDescriptor propertyDescriptor : propertyDescriptors) {
            if (isRequired(propertyDescriptor)
                    && hasNotBeenDefined(propertyDescriptor, beanDefinition)) {
