...
import org.springframework.orm.jpa.spi.PersistenceInjectionTests.DefaultPublicPersistenceContextSetter;
import org.springframework.orm.jpa.spi.PersistenceInjectionTests.DefaultPublicPersistenceUnitSetterNamedPerson;

/**
 * @author Rod Johnson
 *
 */
public class PersistenceInjectionIntegrationTests extends AbstractContainerEntityManagerFactoryBeanIntegrationTests {
	...
	public void testInjectedEntityManagerImplmentsPortableEntityManagerPlus() {
		EntityManager injectedEm = defaultSetterInjected.getEntityManager();
		assertNotNull("Default PersistenceContext Setter was injected", injectedEm);
		ContainerEntityManagerFactoryBeanIntegrationTests.verifyImplementsPortableEntityManagerPlus(injectedEm);
	}
