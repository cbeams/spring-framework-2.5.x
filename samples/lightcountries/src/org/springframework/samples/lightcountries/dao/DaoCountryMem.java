package org.springframework.samples.lightcountries.dao;
...
import org.springframework.samples.lightcountries.appli.Country;
import org.springframework.samples.lightcountries.appli.ICountry;
...
public class DaoCountryMem implements IDaoCountry, InitializingBean {
	...
	/**
	 * @see org.springframework.samples.lightcountries.dao.IDaoCountry#getAllCountries(java.util.Locale)
	 */
	...
	/**
	 * @see org.springframework.samples.lightcountries.dao.IDaoCountry#getFilteredCountries(java.lang.String, java.lang.String, java.util.Locale)
	 */
	...
	/**
	 * @see org.springframework.samples.lightcountries.dao.IDaoCountry#getCountry(java.lang.String, java.util.Locale)
	 */
	...
	/**
	 * @see org.springframework.samples.lightcountries.dao.IDaoCountry#initBase()
	 */
	...
	/**
	 * @see org.springframework.samples.lightcountries.dao.IDaoCountry#saveCountries(java.util.List, java.util.Locale)
	 */
	...
	/**
	 * @see org.springframework.samples.lightcountries.dao.IDaoCountry#getType()
	 */
