...
It also provides a build script and simple structure for your application. 
...
* lib : binaries required in the WAR's WEB-INF/lib directory. You'll need to copy spring.jar
	and logging libraries here for compilation to succeed.
...
to build a WAR deployment unit.


For compilation to succeed, you must copy the three files to the lib directory
listed in lib/readme.txt.