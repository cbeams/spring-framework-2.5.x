...
public interface View {
	 ...
	 * @param request current portlet RenderRequest
	 * @param response portlet RenderResponse we are building
	 * @throws Exception if rendering failed
	 */
	void render(Map model, RenderRequest request, RenderResponse response) throws Exception;
