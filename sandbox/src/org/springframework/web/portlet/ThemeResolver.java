 ...
 * @see org.springframework.web.portlet.support.RequestContext#getTheme
 */
public interface ThemeResolver {
   ...
   */
	String resolveThemeName(RenderRequest request);
   ...
   */
	void setThemeName(RenderRequest request, RenderResponse response, String themeName);
