 ...
 * to a newly spawned sub flow. Each list item must be a String, a Map
 * or a List. If the list item is a simple String value, the attribute
 * will be mapped as having the same name in the parent flow and in the sub flow.
 ...
 * the child flow. If the list item is itself a List, then that list is itself
 * evaluated recursively, and must itself contain Strings, Lists or Maps.</td>
 * </tr>
 * <tr>
 ...
 * flow and in the child flow. If the list item is a Map, each map entry must
 * be a String key naming the attribute in the sub flow, and a String value
 * naming the attribute in the parent flow. If the list item is itself a List,
 * then that list is itself evaluated recursively, and must itself contain
 * Strings, Lists or Maps.</td>
 * </tr>
 * <tr>
...
public class ParameterizableFlowAttributeMapper implements FlowAttributeMapper, Serializable {
	 ...
	 * evaluated recursively, and must itself contain Strings, Lists or Maps.
	 ...
	 *      which is a Map. Each map entry must be a String key naming the
	 *      attribute in the parent flow, and a String value naming the
