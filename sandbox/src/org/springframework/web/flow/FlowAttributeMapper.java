...
/**
 * A service interface that maps attributes between flows.
 * <p>
 * A attribute mapper may map attributes of a parent flow down to a child flow
 * as <i>input</i> when the child is spawned as a subflow. In addition, a
 * mapper may map attributes of a child flow model back up to a resuming parent
