...
/**
 * Abstract base class for Jasper Reports view that require an
...
public abstract class AbstractWriterDrivenJasperReportsView extends
     ...
     * writing render output to an instance of <code>Writer</code>.
     * 
    ...
    protected void renderView(JasperReport report, Map model,
        ...
        JasperPrint print = JasperReportsUtils.fillReport(report, model,
                dataSource);
