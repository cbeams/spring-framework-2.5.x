 ...
 * @author Keith Donald
 */
public class DefaultFormatterLocator extends AbstractFormatterLocator {

	public DefaultFormatterLocator() {
	...
	public Formatter getNumberFormatter(Class numberClass) {
		return new NumberFormatter(numberClass, NumberFormat.getNumberInstance(getLocale()));
	}
}