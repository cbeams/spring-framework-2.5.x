...
/**
 * Fatal exception thrown when we can't connect to an EIS using JCA.
...
public class CannotGetCciConnectionException extends DataAccessResourceFailureException {
	 ...
	 */
	public CannotGetCciConnectionException(String msg, ClassNotFoundException ex) {
		super(msg, ex);
	}
	 ...
	 */
	public CannotGetCciConnectionException(String msg, NamingException ex) {
		super(msg, ex);
	}
