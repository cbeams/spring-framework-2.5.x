 ...
 * {@link javax.jms.IllegalStateException}.  This exception is thrown when
...
public class IllegalStateException extends JmsException {
     ...
     */
    public IllegalStateException( String s, Throwable ex ) {
        super( s, ex );
    }
     ...
     * (e.g {@link javax.jms.IllegalStateException}) exception that triggered this exception.
