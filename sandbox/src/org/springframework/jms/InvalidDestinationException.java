 ...
 * {@link javax.jms.InvalidDestinationException}.  This exception is thrown when
...
public class InvalidDestinationException extends JmsException {
     ...
     */
    public InvalidDestinationException( String s, Throwable ex ) {
        super( s, ex );
    }
     ...
     * exception (e.g {@link javax.jms.InvalidDestinationException}) that triggered
     * this exception.
