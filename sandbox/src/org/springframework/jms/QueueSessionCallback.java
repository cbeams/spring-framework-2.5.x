 ...
 * to access functionality specific to the queue messaging domain.  
 * The JMS 1.1 added these domain specific methods at the Session level.  
 *
 * @author Mark Pollack
 */
public interface QueueSessionCallback
{
    void doInJms(QueueSession session) throws JMSException;
}
