 ...
 * {@link javax.jms.MessageEOFException}.  This exception is thrown when
...
public class MessageEOFException extends JmsException {
     ...
     */
    public MessageEOFException( String s ) {
        super( s );
    }
     ...
     */
    public MessageEOFException( String s, Throwable ex ) {
        super( s, ex );
    }
     ...
     * exception (e.g {@link javax.jms.MessageEOFException}) that triggered
     * this exception.
     *
     * @param cause the cause of this exception
     */
    public MessageEOFException( Throwable cause ) {
        super( cause );
    }
