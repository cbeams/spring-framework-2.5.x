...
public class StringLengthConstraint implements UnaryPredicate {
    ...
    public StringLengthConstraint(RelationalOperator operator, int length) {
        ...
        UnaryPredicate lengthConstraint = PredicateFactory.bind(comparer,
                new Integer(length));
        this.lengthConstraint = PredicateFactory.attachResultConstraint(lengthConstraint,
    ...
    public StringLengthConstraint(int min, int max) {
        ...
        UnaryPredicate rangeConstraint = new Range(new Integer(min),
                new Integer(max));
        this.lengthConstraint = PredicateFactory.attachResultConstraint(rangeConstraint,
                StringLength.instance());
    }
