...
public final class Range extends AbstractConstraint {
    ...
    public Range(Comparable min, Comparable max, boolean inclusive) {
        ...
        if (this.inclusive) {
            ...
            minimum = bind(GreaterThanEqualTo.instance(), min);
            maximum = bind(LessThanEqualTo.instance(), max);
        }
        else {
            Assert.isTrue(LessThan.instance().test(min, max), "Minimum " + min
                    + " must be less than maximum " + max);
            minimum = bind(GreaterThan.instance(), min);
            maximum = bind(LessThan.instance(), max);
        }
    ...
    private void commonAssert(Object min, Object max) {
        ...
        Assert.isTrue(min.getClass().equals(max.getClass()),
                "Min and max must be of the same class");
    }
    ...
    public String toString() {
        return new ToStringCreator(this).append("rangeConstraint",
