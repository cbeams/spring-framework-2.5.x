...
/**
 * Wrapper for the commons validator to be used with the spring framework.
 * <p>
 * Use this class to validate any generic bean that does not have a known class
 * name. The bean (class) name can be configured in the Application Context.
 ...
 * separate NamedBeanValidator for each different type of been to be validated.
 * <p>
 * With the validate(beanName, obj, errors) method, a single NamedBeanValidator
 ...
 * validate() methods may be invoked (for zero-argument construction only):
 * <ul>
 ...
 */
public class NamedBeanValidator implements
        org.springframework.validation.Validator, Serializable {
     ...
     * 
     * @param beanName
     *            String containing the name of the bean to validate. This value
     *            is used to locate rules with which to validate the bean.
     * @param obj
     *            Object to validate.
     * @param errors
     *            Errors instance to which validation errors will be added.
     */
     ...
     * 
     * @param factory
     *            an initialized instance of ValidatorFactory.
     */
