...
/**
 * Callback interface for Hibernate code. To be used with {@link org.springframework.orm.hibernate3.HibernateTemplate}'s
 ...
 */
public interface StatelessHibernateCallback {
	 ...
	 * @throws org.hibernate.HibernateException if thrown by the Hibernate API
	 * @throws java.sql.SQLException if thrown by Hibernate-exposed JDBC API
	 * @see org.springframework.orm.hibernate3.HibernateTemplate#execute
	 * @see org.springframework.orm.hibernate3.HibernateTemplate#executeFind
	 */
	Object doInHibernate(StatelessSession session) throws HibernateException, SQLException;
