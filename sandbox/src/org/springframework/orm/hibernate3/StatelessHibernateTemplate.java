 ...
 */
public class StatelessHibernateTemplate extends HibernateAccessor implements HibernateOperations {
	 ...
	 */
	public StatelessHibernateTemplate() {
	}
	 ...
	 */
	public StatelessHibernateTemplate(SessionFactory sessionFactory) {
	 ...
	 */
	public StatelessHibernateTemplate(SessionFactory sessionFactory, boolean allowCreate) {
		setSessionFactory(sessionFactory);
	...
	public Object executeStateless(StatelessHibernateCallback action) throws DataAccessException {
		return executeStateless(action, isExposeNativeSession());
	}
	 ...
	 * @throws org.springframework.dao.DataAccessException in case of Hibernate errors
	 */
	public Object executeStateless(StatelessHibernateCallback action, boolean exposeNativeSession) throws DataAccessException {
		Assert.notNull(action, "Callback object must not be null");
	...
	public Object get(final Class entityClass, final Serializable id, final LockMode lockMode)
		...
		return execute(new CombinedHibernateCallback() {
			...
			public Object doInHibernate(StatelessSession session) throws HibernateException, SQLException {
				if (lockMode != null) {
					return session.get(entityClass, id, lockMode);
				}
				else {
	...
	public List findByExample(
		...
		return (List) execute(new CombinedHibernateCallback() {
			public Object doInHibernate(Session session) throws HibernateException {
				return executeCriteria(entityName != null ?
			...
			private List executeCriteria(Criteria executableCriteria) {
	...
	public Iterator iterate(final String queryString, final Object[] values) throws DataAccessException {
		return (Iterator) execute(new CombinedHibernateCallback() {
			public Object doInHibernate(Session session) throws HibernateException {
				return executeQuery(session.createQuery(queryString));
			}
			public Object doInHibernate(StatelessSession session) throws HibernateException {
			...
			private Iterator executeQuery(Query queryObject) {
				prepareQuery(queryObject);
				if (values != null) {
					for (int i = 0; i < values.length; i++) {
						queryObject.setParameter(i, values[i]);
	...
	public int bulkUpdate(final String queryString, final Object[] values) throws DataAccessException {
		Integer updateCount = (Integer) execute(new CombinedHibernateCallback() {
			public Object doInHibernate(Session session) throws HibernateException {
				return executeQuery(session.createQuery(queryString));
			}
			public Object doInHibernate(StatelessSession session) throws HibernateException {
			...
			private Integer executeQuery(Query queryObject) {
				prepareQuery(queryObject);
				if (values != null) {
					for (int i = 0; i < values.length; i++) {
						queryObject.setParameter(i, values[i]);
	...
	private interface CombinedHibernateCallback extends HibernateCallback, StatelessHibernateCallback {
	}
