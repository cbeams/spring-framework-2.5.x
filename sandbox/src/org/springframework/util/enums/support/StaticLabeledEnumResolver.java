...
import org.springframework.util.closure.support.AbstractLocalProcessTemplate;
...
public class StaticLabeledEnumResolver extends AbstractLabeledEnumResolver {
	 ...
	 * @author Keith Donald
	 */
	private static class LabeledEnumFieldValueGenerator extends AbstractLocalProcessTemplate {
