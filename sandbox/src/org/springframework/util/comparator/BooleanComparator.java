...
public final class BooleanComparator implements Comparator, Serializable {
	private static final BooleanComparator TRUE_LOW = new BooleanComparator(true);

	private static final BooleanComparator TRUE_HIGH = new BooleanComparator(false);
	...
	public String toString() {
		return new ToStringCreator(this).append("trueFirst", trueLow).toString();
	}
}