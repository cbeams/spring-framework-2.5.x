...
public class PropertyComparator implements Comparator, Serializable {
    ...
    public PropertyComparator(String property) {
        this(property, new NullSafeComparator(ComparableComparator.instance()));
    }
    ...
    public int compare(Object o1, Object o2) {
        if (property == null) { return comparator.compare(o1, o2); }
        if (beanWrapper == null) {
    ...
    public String toString() {
        return new ToStringCreator(this).append("property", property).append(
