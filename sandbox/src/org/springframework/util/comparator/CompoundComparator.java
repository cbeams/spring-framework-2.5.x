 ...
 *
 * @author Keith Donald, adapted from jakarta-commons-lang's ComparatorChain
 */
public class CompoundComparator implements Comparator, Serializable {
	 ...
	 */
	public CompoundComparator(List comparators, BitSet sortOrder) {
		Assert.notNull(comparators, "comparators is required");
		Assert.notNull(sortOrder, "sortOrder is required");
	...
	public void addComparator(Comparator comparator, boolean reverse) {
		...
		if (locked) {
			throw new IllegalStateException("CompoundComparator is locked");
		}
	...
	public void setForwardSort(int index) {
		...
		Assert.isTrue(0 < index && index < comparators.size(),
				"forwardSort needs to be between 0 and " + comparators.size());
		sortOrder.clear(index);
	}
	...
	public void setReverseSort(int index) {
		...
		Assert.isTrue(0 < index && index < comparators.size(),
				"reverseSort needs to be between 0 and " + comparators.size());
		sortOrder.set(index);
	}
