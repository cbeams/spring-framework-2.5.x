...
import org.springframework.orm.toplink.mock.MockJtaTransaction;
 ...
 * @since 08.07.2004
 */
public class JtaTransactionTests extends TestCase {
	...
	public void testParticipatingJtaTransactionWithWithRequiresNew() throws Exception {
		...
		MockControl session1Control = MockControl.createControl(SpringSession.class);
		SpringSession session1 = (SpringSession) session1Control.getMock();
		MockControl session2Control = MockControl.createControl(SpringSession.class);
...
//		session2Control.setReturnValue(true,1);
	...
	private void doTestJtaTransactionCommit(int status) throws Exception {
		...
		final MockControl sessionControl = MockControl.createControl(SpringSession.class);
