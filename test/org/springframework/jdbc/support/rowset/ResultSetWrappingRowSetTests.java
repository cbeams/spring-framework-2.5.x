...
public class ResultSetWrappingRowSetTests extends TestCase {
	...
	throws Exception {		
		...
		Method rowset = ResultSetWrappingSqlRowSet.class.getDeclaredMethod(
				"getBigDecimal", new Class[] { int.class });
	...
	throws Exception {		
		...
		Method rowset = ResultSetWrappingSqlRowSet.class.getDeclaredMethod(
				"getBigDecimal", new Class[] { String.class });
	...
	throws Exception {		
		...
		Method rowset = ResultSetWrappingSqlRowSet.class.getDeclaredMethod(
				"getString", new Class[] { String.class });
	...
	throws Exception {		
		...
		Method rowset = ResultSetWrappingSqlRowSet.class.getDeclaredMethod(
				"getTimestamp", new Class[] { int.class });
	...
	throws Exception {		
		...
		Method rowset = ResultSetWrappingSqlRowSet.class.getDeclaredMethod(
				"getTimestamp", new Class[] { String.class });
	...
	throws Exception {		
		...
		Method rowset = ResultSetWrappingSqlRowSet.class.getDeclaredMethod(
				"getDate", new Class[] { String.class });
	...
	throws Exception {		
		...
		Method rowset = ResultSetWrappingSqlRowSet.class.getDeclaredMethod(
				"getTime", new Class[] { String.class });
	...
	throws Exception {		
		...
		Method rowset = ResultSetWrappingSqlRowSet.class.getDeclaredMethod(
				"getFloat", new Class[] { String.class });
	...
	throws Exception {		
		...
		Method rowset = ResultSetWrappingSqlRowSet.class.getDeclaredMethod(
				"getDouble", new Class[] { String.class });
	...
	throws Exception {		
		...
		Method rowset = ResultSetWrappingSqlRowSet.class.getDeclaredMethod(
				"getLong", new Class[] { String.class });
	...
	public void testGetBooleanInt() throws Exception {		
		...
		Method rowset = ResultSetWrappingSqlRowSet.class.getDeclaredMethod(
				"getBoolean", new Class[] { int.class });
	...
	throws Exception {		
		...
		Method rowset = ResultSetWrappingSqlRowSet.class.getDeclaredMethod(
				"getBoolean", new Class[] { String.class });
